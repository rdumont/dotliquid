...
namespace DotLiquid.Tests
{
	...
	public class ContextTests
	{
		...
		public void TestOverrideGlobalFilter()
		{
            ...
            Assert.AreEqual("Global test", Template.ParseAsync("{{'test' | notice }}").Result.RenderAsync().Result);
            Assert.AreEqual("Local test", Template.ParseAsync("{{'test' | notice }}").Result.RenderAsync(new RenderParameters { Filters = new[] { typeof(LocalFilters) } }).Result);
		}
